...
package org.solarisj.tools;

import org.solarisj.core.*;
import org.solarisj.crypto.*;
import org.solarisj.net.discovery.DnsDiscovery;
import org.solarisj.params.MainNetParams;
import org.solarisj.params.RegTestParams;
import org.solarisj.params.TestNet3Params;
import org.solarisj.protocols.payments.PaymentProtocol;
import org.solarisj.protocols.payments.PaymentProtocolException;
import org.solarisj.protocols.payments.PaymentSession;
import org.solarisj.script.ScriptBuilder;
import org.solarisj.store.*;
import org.solarisj.uri.SolarisURI;
import org.solarisj.uri.BitcoinURIParseException;
import org.solarisj.utils.BriefLogFormatter;
import org.solarisj.wallet.DeterministicSeed;
import org.solarisj.wallet.DeterministicUpgradeRequiredException;
import org.solarisj.wallet.DeterministicUpgradeRequiresPassword;
...
import org.solarisj.core.listeners.BlocksDownloadedEventListener;
import org.solarisj.core.listeners.DownloadProgressTracker;
import org.solarisj.wallet.MarriedKeyChain;
import org.solarisj.wallet.Protos;
import org.solarisj.wallet.SendRequest;
import org.solarisj.wallet.Wallet;
import org.solarisj.wallet.WalletExtension;
import org.solarisj.wallet.WalletProtobufSerializer;
...
import static org.solarisj.core.Coin.parseCoin;
        ...
        if (location.startsWith("http") || location.startsWith(CoinDefinition.coinURIScheme)) {
            try {
                ...
                if (location.startsWith("http")) {
                    ...
                    SolarisURI paymentRequestURI = new SolarisURI(location);
