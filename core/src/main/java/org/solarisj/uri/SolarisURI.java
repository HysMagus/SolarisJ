...
import org.solarisj.params.AbstractBitcoinNetParams;
...
public class SolarisURI {
    ...
    /**
     * URI for Bitcoin network. Use {@link org.solarisj.params.AbstractBitcoinNetParams#BITCOIN_SCHEME} if you specifically
     * need Bitcoin, or use {@link org.solarisj.core.NetworkParameters#getUriScheme} to get the scheme
    ...
    /**
     * Constructs a new SolarisURI from the given string. Can be for any network.
     *
     ...
     */
    public SolarisURI(String uri) throws BitcoinURIParseException {
        this(null, uri);
    }
     ...
     */
    public SolarisURI(@Nullable NetworkParameters params, String input) throws BitcoinURIParseException {
        checkNotNull(input);
    ...
    public String toString() {
        StringBuilder builder = new StringBuilder("SolarisURI[");
        boolean first = true;
