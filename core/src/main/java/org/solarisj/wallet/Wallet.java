...
import org.solarisj.core.Message;
import org.solarisj.core.listeners.*;
import org.solarisj.core.TransactionConfidence.*;
import org.solarisj.crypto.*;
import org.solarisj.script.*;
import org.solarisj.signers.*;
import org.solarisj.utils.*;
import org.solarisj.wallet.Protos.Wallet.*;
import org.solarisj.wallet.WalletTransaction.*;
import org.solarisj.wallet.listeners.KeyChainEventListener;
import org.solarisj.wallet.listeners.ScriptsChangeEventListener;
import org.solarisj.wallet.listeners.WalletChangeEventListener;
import org.solarisj.wallet.listeners.WalletCoinsReceivedEventListener;
import org.solarisj.wallet.listeners.WalletCoinsSentEventListener;
import org.solarisj.wallet.listeners.WalletEventListener;
import org.solarisj.wallet.listeners.WalletReorganizeEventListener;
import org.slf4j.*;
 ...
 * {@link Wallet#autosaveToFile(java.io.File, long, java.util.concurrent.TimeUnit, org.solarisj.wallet.WalletFiles.Listener)}
...
public class Wallet extends BaseTaggableObject
    ...
    private Wallet(Context context, KeyChainGroup keyChainGroup) {
        ...
        //this.version = this.keyChainGroup.getActiveKeyChain().getKeyChainType() == DeterministicKeyChain.KeyChainType.BIP44_Solaris_ONLY? 1 : 0;
     ...
     * {@link org.solarisj.wallet.KeyChain.KeyPurpose#RECEIVE_FUNDS}. The returned key is stable until
    ...
    /**
     * An alias for calling {@link #currentKey(org.solarisj.wallet.KeyChain.KeyPurpose)} with
     * {@link org.solarisj.wallet.KeyChain.KeyPurpose#RECEIVE_FUNDS} as the parameter.
     */
    ...
    /**
     * Returns address for a {@link #currentKey(org.solarisj.wallet.KeyChain.KeyPurpose)}
     */
    ...
    /**
     * An alias for calling {@link #currentAddress(org.solarisj.wallet.KeyChain.KeyPurpose)} with
     * {@link org.solarisj.wallet.KeyChain.KeyPurpose#RECEIVE_FUNDS} as the parameter.
     */
     ...
     * {@link org.solarisj.wallet.DeterministicKeyChain}. When the parameter is
     * {@link org.solarisj.wallet.KeyChain.KeyPurpose#RECEIVE_FUNDS} the returned key is suitable for being put
    ...
    /**
     * An alias for calling {@link #freshKey(org.solarisj.wallet.KeyChain.KeyPurpose)} with
     * {@link org.solarisj.wallet.KeyChain.KeyPurpose#RECEIVE_FUNDS} as the parameter.
     */
    ...
    /**
     * Returns address for a {@link #freshKey(org.solarisj.wallet.KeyChain.KeyPurpose)}
     */
    ...
    /**
     * An alias for calling {@link #freshAddress(org.solarisj.wallet.KeyChain.KeyPurpose)} with
     * {@link org.solarisj.wallet.KeyChain.KeyPurpose#RECEIVE_FUNDS} as the parameter.
     */
     ...
     * key, after loading a wallet produced by previous versions of solarisj. If the wallet is encrypted the key
     ...
     * If {@link Wallet#autosaveToFile(java.io.File, long, java.util.concurrent.TimeUnit, org.solarisj.wallet.WalletFiles.Listener)}
    ...
    /** See {@link org.solarisj.wallet.DeterministicKeyChain#setLookaheadSize(int)} for more info on this. */
    ...
    /** See {@link org.solarisj.wallet.DeterministicKeyChain#setLookaheadThreshold(int)} for more info on this. */
     ...
     * See {@link org.solarisj.wallet.DeterministicKeyChain#markKeyAsUsed(DeterministicKey)} for more info on this.
     */
     ...
     * @throws org.solarisj.core.ECKey.MissingPrivateKeyException if the seed is unavailable (watching wallet)
     */
    ...
    /**
     * Convenience wrapper around {@link Wallet#encrypt(org.solarisj.crypto.KeyCrypter,
     ...
     * {@link org.solarisj.crypto.KeyCrypterScrypt}.
     *
     ...
     * of {@link org.solarisj.core.ECKey#getCreationTimeSeconds()}. This can return zero if at least one key does
     ...
     * you can use {@link org.solarisj.utils.Threading#waitForUserCode()} to block until the future had a
    ...
    public enum MissingSigsMode {
        ...
        USE_DUMMY_SIG,
        /**
         * If signature is missing, {@link org.solarisj.signers.TransactionSigner.MissingSignatureException}
     ...
     */
    public void setTransactionBroadcaster(@Nullable org.solarisj.core.TransactionBroadcaster broadcaster) {
     ...
     * @throws org.solarisj.wallet.DeterministicUpgradeRequiresPassword if key rotation requires the users password.
     */
