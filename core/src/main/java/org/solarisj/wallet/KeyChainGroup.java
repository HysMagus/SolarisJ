...
/**
 * <p>A KeyChainGroup is used by the {@link org.solarisj.wallet.Wallet} and
...
public class KeyChainGroup implements KeyBag {
     ...
     *
     * @throws org.solarisj.crypto.KeyCrypterException Thrown if the wallet encryption fails for some reason,
     ...
     * KeyCrypter to use is {@link org.solarisj.crypto.KeyCrypterScrypt}.
     *
     * @throws org.solarisj.crypto.KeyCrypterException Thrown if the wallet decryption fails for some reason, leaving the group unchanged.
     */
