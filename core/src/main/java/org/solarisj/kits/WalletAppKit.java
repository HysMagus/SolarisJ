...
import org.solarisj.protocols.channels.*;
...
/**
 * <p>Utility class that wraps the boilerplate needed to set up a new SPV solarisj app. Instantiate it with a directory
 ...
 * It is to make it easier to fit solarisj into GUI apps, which require a high degree of responsiveness on their main
 * thread which handles all the animation and user interaction. Even when blockingStart is false, initializing solarisj
...
public class WalletAppKit extends AbstractIdleService {
    ...
    public WalletAppKit(Context context, File directory, String filePrefix) {
        ...
        context.initSolaris(false, true);
     ...
     * {@link org.solarisj.core.DownloadProgressTracker} is a good choice. This has no effect unless setBlockingStartup(false) has been called
     ...
     * block sync faster for new users - please refer to the documentation on the solarisj website for further details.
     */
