...
public class ECKey implements EncryptableItem {
     ...
     * @throws org.solarisj.core.ECKey.MissingPrivateKeyException if the private key is missing or encrypted.
     */
    public byte[] toASN1() {
        try {
     ...
     * usually encoded using ASN.1 format, so you want {@link org.solarisj.core.ECKey.ECDSASignature#toASN1()}
    ...
    /**
     * Signs the given hash and returns the R and S components as BigIntegers. In the Bitcoin protocol, they are
     * usually encoded using DER format, so you want {@link org.solarisj.core.ECKey.ECDSASignature#encodeToDER()}
     ...
     * @throws org.solarisj.core.ECKey.MissingPrivateKeyException if the private key bytes are missing/encrypted.
     */
     ...
     * the {@link org.solarisj.core.DumpedPrivateKey#toString()} method to get the string.
     *
