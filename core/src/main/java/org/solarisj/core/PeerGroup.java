...
import org.solarisj.net.*;
import org.solarisj.net.discovery.*;
...
public class PeerGroup implements TransactionBroadcaster {
     ...
     * FP rate is chosen for performance rather than privacy. If a future version of solarisj fixes the known
     ...
     * {@link org.solarisj.core.listeners.PeerConnectionEventListener} and use the onPeerConnected/onPeerDisconnected methods.
     */
     ...
     *         Use {@link org.solarisj.core.Peer#getConnectionOpenFuture()} if you
     ...
     * peers. By using this with {@link org.solarisj.core.PeerGroup#getMaxConnections()} you can wait until the
     ...
     * {@link org.solarisj.core.PeerGroup#getMaxConnections()} returns is used.
     */
    ...
    /**
     * See {@link org.solarisj.core.PeerGroup#getMinBroadcastConnections()}.
     */
     ...
     * {@link org.solarisj.core.TransactionBroadcast#future()} method will be completed. If anything goes
     ...
     *
     * <p>The returned {@link org.solarisj.core.TransactionBroadcast} object can be used to get progress feedback,
     ...
     * times are available via {@link org.solarisj.core.Peer#getLastPingTime()} but it increases load on the
     ...
     * using {@link org.solarisj.core.Peer#ping()}.
     */
     ...
     * and easy way for a user to upgrade a solarisj based app running in SPV mode to fully validating security.
     */
