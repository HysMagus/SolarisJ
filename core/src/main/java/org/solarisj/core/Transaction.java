...
import org.solarisj.crypto.TransactionSignature;
...
import static org.solarisj.core.Utils.*;
...
public class Transaction extends ChildMessage {
    ...
    /**
     * Same as {@link #addSignedInput(TransactionOutPoint, org.solarisj.script.Script, ECKey, org.solarisj.core.Transaction.SigHash, boolean)}
     ...
     * a wrapper around calling {@link Transaction#hashForSignature(int, byte[], org.solarisj.core.Transaction.SigHash, boolean)}
    ...
    /**
     * Returns the confidence object for this transaction from the {@link org.solarisj.core.TxConfidenceTable}
    ...
    public void verify() throws VerificationException {
        ...
        if (isCoinBase()) {
            ...
            if (scriptBytes.length < 2 || scriptBytes.length > 150) {
