...
public class BlockChain extends AbstractBlockChain {
     ...
     *
     * <p>For the store, you should use {@link org.solarisj.store.SPVBlockStore} or you could also try a
     * {@link org.solarisj.store.MemoryBlockStore} if you want to hold all headers in RAM and don't care about
