...
public class VersionMessage extends Message {
    ...
    public static final String BITCOINJ_VERSION = "1.0";
     ...
     * name:version pairs separated by slashes in the form of a path. For example a typical subVer field for solarisj
     * users might look like "/solarisj:0.13/MultiBit:1.2/" where libraries come further to the left.<p>
     *
     ...
     * set of "/solarisj:1.0/MultiBit:1.0(Windows)/". Therefore the / ( and ) characters are reserved in all these
