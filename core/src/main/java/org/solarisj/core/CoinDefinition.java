...
public class CoinDefinition {
    ...
    public static final String coinName = "Solaris";
    public static final String coinTicker = "XLR";
    public static final String coinURIScheme = "solaris";
    public static final String cryptsyMarketId = "155";
    public static final String cryptsyMarketCurrency = "XLR";
    ...
    public static final String BLOCKEXPLORER_BASE_URL_PROD = "https://solaris.blockexplorer.pro/";    //blockr.io
    public static final String BLOCKEXPLORER_ADDRESS_PATH = "address/";             //blockr.io path
    public static final String BLOCKEXPLORER_TRANSACTION_PATH = "tx/";              //blockr.io path
    public static final String BLOCKEXPLORER_BLOCK_PATH = "block/";                 //blockr.io path
    public static final String BLOCKEXPLORER_BASE_URL_TEST = "https://solaris.blockexplorer.pro/";

    public static final String DONATION_ADDRESS = "SbUn75nwFqsdqRVt3yRt6EBXw8DZPLgFqs";  //Hash Engineering donation DASH address
    ...
    // Solaris
    //
    public static final int PROTOCOL_VERSION = 70717;          //version.h PROTOCOL_VERSION
    public static final int MIN_PROTOCOL_VERSION = 70716;        //version.h MIN_PROTO_VERSION
    ...
    public static final int Port    = 60020;       //protocol.h GetDefaultPort(testnet=false)
   ...
   // public static final long MAINNET_ZEROCOIN_STARTING_BLOCK_HEIGHT = 259300;
    public static final long MAINNET_ZEROCOIN_STARTING_BLOCK_HEIGHT = 259680;
    ...
    public static final long PacketMagic = 0x022101a1;

    //Genesis Block Information from main.cpp: LoadBlockIndex
    static public long genesisBlockDifficultyTarget = 0x1e0ffff0L;         //main.cpp: LoadBlockIndex
    static public long genesisBlockTime = 1506779239L;                       //main.cpp: LoadBlockIndex
    static public long genesisBlockNonce = 500317;                         //main.cpp: LoadBlockIndex
    static public String genesisHash = "00000c393bf1eaf9757be560092cc08a7b1ff0345e874b12521522e27862d7d7";  //main.cpp: hashGenesisBlock
    static public String genesisMerkleRoot = "a84934befc603b6dc91cd53895bf45cd056b4e7a9562067d7608b94e8704815d";
    ...
    static public String[] dnsSeeds = new String[] {
            "solarisnode.dyndns.org",
            "solarisnode1.dyndns.org",
            "solarisnode2.dyndns.org",
            "solarisnode3.dyndns.org",
            "solarisnode4.dyndns.org",
            "solarisnode5.dyndns.org",
            "solarisnode6.dyndns.org",
            "node1.solariscoin.com",
            "node2.solariscoin.com",
            "node3.solariscoin.com",
            "node4.solariscoin.com",
            "node5.solariscoin.com",
            "node6.solariscoin.com"
    };
    ...
    public static final String ID_MAINNET = "org.solaris.production";
    /** The string returned by getId() for the testnet. */
    public static final String ID_TESTNET = "org.solaris.test";
    /** Unit test network. */
    public static final String ID_UNITTESTNET = "com.google.solaris.unittest";
