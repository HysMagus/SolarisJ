...
import com.hashengineering.crypto.Xevan;
...
import static org.solarisj.core.Sha256Hash.*;
...
public class Block extends Message {
     ...
     *
     * <p>The half-life is controlled by {@link org.solarisj.core.NetworkParameters#getSubsidyDecreaseBlockCount()}.
     * </p>
     */
    ...
    protected void parse() throws ProtocolException {
        try {
            ...
            if (isZerocoin() && length >= ZEROCOIN_HEADER_SIZE) {
               ...
               // System.out.println("Hash payload "+Arrays.toString(payload));
               ...
               // System.out.println("zerocoin hash parsed: "+hash.toString());
                ...
                hash = Sha256Hash.wrapReversed(Xevan.XevanDigest(payload, offset, cursor - offset));
    ...
    private Sha256Hash calculateHash() {
        try {
            ...
            return Sha256Hash.wrap(
                    Utils.reverseBytes(
                           // isZerocoin()?       Sha256Hash.hashTwice(bos.toByteArray())       :  Xevan.XevanDigest(bos.toByteArray())
                            Xevan.XevanDigest(bos.toByteArray())
                    )
                    );
        } catch (IOException e) {
     ...
     * {@link org.solarisj.core.Block#getDifficultyTargetAsInteger()}. Note that this is <b>not</b> the same as
