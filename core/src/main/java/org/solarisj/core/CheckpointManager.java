 ...
 * {@link org.solarisj.store.SPVBlockStore}s. They are not used by fully validating mode, which instead has a
...
public class CheckpointManager {
    ...
    /** Loads the default checkpoints bundled with solarisj */
    ...
    /** Returns a checkpoints stream pointing to inside the solarisj JAR */
