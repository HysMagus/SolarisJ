...
import org.solarisj.net.discovery.HttpDiscovery;
import org.solarisj.params.*;
import org.solarisj.script.Script;
import org.solarisj.script.ScriptBuilder;
import org.solarisj.script.ScriptChunk;
import org.solarisj.script.ScriptOpCodes;
...
import org.solarisj.utils.VersionTally;
...
public abstract class NetworkParameters {
    ...
    public static final String ID_REGTEST = "org.solaris.regtest";
    ...
    private static Block createGenesis(NetworkParameters n) {
        ...
        try {
            ...
            //
            //   coin dependent
            byte[] bytes = Utils.HEX.decode("04ffff001d010412536f6c617269732033302d30392d32303137");//CoinDefinition.genesisTxInBytes);
            ...
            byte[] pubKey = Utils.HEX.decode("045da9271f5d9df405d9e83c7c7e62e9c831cc85c51ffaa6b515c4f9c845dec4bf256460003f26ba9d394a17cb57e6759fe231eca75b801c20bccd19cbe4b7942d");
        ...
        if (!tx.getHashAsString().equals("a84934befc603b6dc91cd53895bf45cd056b4e7a9562067d7608b94e8704815d")) throw new IllegalStateException("invalid genesis tx: "+tx.getHashAsString());
        return genesisBlock;
    }
    ...
    /** Returns discovery objects for seeds implementing the Cartographer protocol. See {@link org.solarisj.net.discovery.HttpDiscovery} for more info. */
    ...
    /**
     * First byte of a base58 encoded address. See {@link org.solarisj.core.Address}. This is the same as acceptableAddressCodes[0] and
    ...
    /** First byte of a base58 encoded dumped private key. See {@link org.solarisj.core.DumpedPrivateKey}. */
    ...
    /**
     * The key used to sign {@link org.solarisj.core.AlertMessage}s. You can use {@link org.solarisj.core.ECKey#verify(byte[], byte[], byte[])} to verify
     * signatures using it.
     */
