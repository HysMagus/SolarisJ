...
package org.solarisj.protocols.payments;

import org.solarisj.core.*;
import org.solarisj.crypto.TrustStoreLoader;
import org.solarisj.params.MainNetParams;
import org.solarisj.protocols.payments.PaymentProtocol.PkiVerificationData;
 ...
 *
 * <ul>
 * <li>A {@link SolarisURI} object that conforms to BIP 0072</li>
 * <li>A url where the {@link Protos.PaymentRequest} can be fetched</li>
 * <li>Directly with a {@link Protos.PaymentRequest} object</li>
 * </ul>
 *
 * <p>If initialized with a SolarisURI or a url, a network request is made for the payment request object and a
...
public class PaymentSession {
     ...
     * uri is a BIP-72-style SolarisURI object that specifies where the {@link Protos.PaymentRequest} object may
     ...
     * be verified.</p>
     */
    public static ListenableFuture<PaymentSession> createFromBitcoinUri(final SolarisURI uri) throws PaymentProtocolException {
     ...
     */
    public static ListenableFuture<PaymentSession> createFromBitcoinUri(final SolarisURI uri, final boolean verifyPki)
     ...
     */
    public static ListenableFuture<PaymentSession> createFromBitcoinUri(final SolarisURI uri, final boolean verifyPki, @Nullable final TrustStoreLoader trustStoreLoader)
            throws PaymentProtocolException {
        String url = uri.getPaymentRequestUrl();
        if (url == null)
            throw new PaymentProtocolException.InvalidPaymentRequestURL("No payment request URL (r= parameter) in SolarisURI " + uri);
        try {
