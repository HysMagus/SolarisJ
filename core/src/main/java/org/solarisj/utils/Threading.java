 ...
 * solarisj performs cycle detection or not. Cycle detection is useful to detect bugs but comes with a small cost.
...
public class Threading {
     ...
     * solarisj internally shouldn't normally run here, although currently there are a few exceptions.
     */
     ...
     * solarisj library code is run, setting it after you started network traffic and other forms of processing
    ...
    static {
        ...
        // instantiating any solarisj objects. The policy change will take effect only on new objects
