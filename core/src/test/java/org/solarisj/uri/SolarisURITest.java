...
package org.solarisj.uri;

import org.solarisj.core.Address;
import org.solarisj.params.MainNetParams;
import org.solarisj.params.TestNet3Params;
import com.google.common.collect.ImmutableList;
import org.junit.Test;
import org.solarisj.core.CoinDefinition;

import static org.solarisj.core.Coin.*;
import org.solarisj.core.NetworkParameters;
import static org.junit.Assert.*;

public class SolarisURITest {
    private SolarisURI testObject = null;
    ...
    public void testConvertToBitcoinURI() throws Exception {
        ...
        // simple example
        assertEquals(CoinDefinition.coinURIScheme + ":" + MAINNET_GOOD_ADDRESS + "?amount=12.34&label=Hello&message=AMessage", SolarisURI.convertToBitcoinURI(goodAddress, parseCoin("12.34"), "Hello", "AMessage"));
        
        // example with spaces, ampersand and plus
        assertEquals(CoinDefinition.coinURIScheme + ":" + MAINNET_GOOD_ADDRESS + "?amount=12.34&label=Hello%20World&message=Mess%20%26%20age%20%2B%20hope", SolarisURI.convertToBitcoinURI(goodAddress, parseCoin("12.34"), "Hello World", "Mess & age + hope"));

        // no amount, label present, message present
        assertEquals(CoinDefinition.coinURIScheme + ":" + MAINNET_GOOD_ADDRESS + "?label=Hello&message=glory", SolarisURI.convertToBitcoinURI(goodAddress, null, "Hello", "glory"));
        
        // amount present, no label, message present
        assertEquals(CoinDefinition.coinURIScheme + ":" + MAINNET_GOOD_ADDRESS + "?amount=0.1&message=glory", SolarisURI.convertToBitcoinURI(goodAddress, parseCoin("0.1"), null, "glory"));
        assertEquals(CoinDefinition.coinURIScheme + ":" + MAINNET_GOOD_ADDRESS + "?amount=0.1&message=glory", SolarisURI.convertToBitcoinURI(goodAddress, parseCoin("0.1"), "", "glory"));

        // amount present, label present, no message
        assertEquals(CoinDefinition.coinURIScheme + ":" + MAINNET_GOOD_ADDRESS + "?amount=12.34&label=Hello", SolarisURI.convertToBitcoinURI(goodAddress, parseCoin("12.34"), "Hello", null));
        assertEquals(CoinDefinition.coinURIScheme + ":" + MAINNET_GOOD_ADDRESS + "?amount=12.34&label=Hello", SolarisURI.convertToBitcoinURI(goodAddress, parseCoin("12.34"), "Hello", ""));
              
        // amount present, no label, no message
        assertEquals(CoinDefinition.coinURIScheme + ":" + MAINNET_GOOD_ADDRESS + "?amount=1000", SolarisURI.convertToBitcoinURI(goodAddress, parseCoin("1000"), null, null));
        assertEquals(CoinDefinition.coinURIScheme + ":" + MAINNET_GOOD_ADDRESS + "?amount=1000", SolarisURI.convertToBitcoinURI(goodAddress, parseCoin("1000"), "", ""));

        // no amount, label present, no message
        assertEquals(CoinDefinition.coinURIScheme + ":" + MAINNET_GOOD_ADDRESS + "?label=Hello", SolarisURI.convertToBitcoinURI(goodAddress, null, "Hello", null));
        
        // no amount, no label, message present
        assertEquals(CoinDefinition.coinURIScheme + ":" + MAINNET_GOOD_ADDRESS + "?message=Agatha", SolarisURI.convertToBitcoinURI(goodAddress, null, null, "Agatha"));
        assertEquals(CoinDefinition.coinURIScheme + ":" + MAINNET_GOOD_ADDRESS + "?message=Agatha", SolarisURI.convertToBitcoinURI(goodAddress, null, "", "Agatha"));
      
        // no amount, no label, no message
        assertEquals("bitcoin:" + MAINNET_GOOD_ADDRESS, SolarisURI.convertToBitcoinURI(goodAddress, null, null, null));
        assertEquals("bitcoin:" + MAINNET_GOOD_ADDRESS, SolarisURI.convertToBitcoinURI(goodAddress, null, "", ""));
        ...
        assertEquals("test:" + MAINNET_GOOD_ADDRESS + "?amount=12.34&label=Hello&message=AMessage",
             SolarisURI.convertToBitcoinURI(Address.fromBase58(alternativeParameters, MAINNET_GOOD_ADDRESS), parseCoin("12.34"), "Hello", "AMessage"));
    }

    @Test
    public void testGood_Simple() throws BitcoinURIParseException {
        testObject = new SolarisURI(MAINNET, BITCOIN_SCHEME + ":" + MAINNET_GOOD_ADDRESS);
    ...
    public void testBad_Scheme() {
        try {
            testObject = new SolarisURI(MAINNET, "blimpcoin:" + MAINNET_GOOD_ADDRESS);
    ...
    public void testBad_BadSyntax() {
        ...
        try {
            testObject = new SolarisURI(MAINNET, BITCOIN_SCHEME + ":");
            fail("Expecting BitcoinURIParseException");
        } catch (BitcoinURIParseException e) {
            assertTrue(e.getMessage().contains("Bad URI syntax"));
        }
    ...
    public void testBad_IncorrectAddressType() {
        try {
            testObject = new SolarisURI(TestNet3Params.get(), BITCOIN_SCHEME + ":" + MAINNET_GOOD_ADDRESS);
            fail("Expecting BitcoinURIParseException");
        } catch (BitcoinURIParseException e) {
    ...
    public void testGood_LabelWithAmpersandAndPlus() throws BitcoinURIParseException {
        ...
        String encodedLabel = SolarisURI.encodeURLString(testString);
        testObject = new SolarisURI(MAINNET, BITCOIN_SCHEME + ":" + MAINNET_GOOD_ADDRESS + "?label="
                + encodedLabel);
    ...
    public void testGood_LabelWithRussian() throws BitcoinURIParseException {
        ...
        String encodedLabel = SolarisURI.encodeURLString(moscowString);
        testObject = new SolarisURI(MAINNET, BITCOIN_SCHEME + ":" + MAINNET_GOOD_ADDRESS + "?label="
                + encodedLabel);
    ...
    public void testGood_Combinations() throws BitcoinURIParseException {
        ...
        assertEquals(
                "SolarisURI['amount'='654321000000000','label'='Hello World','message'='Be well','address'='"+CoinDefinition.UNITTEST_ADDRESS+"']",
                testObject.toString());
    }
    ...
    public void testEmpty_Label() throws BitcoinURIParseException {
        assertNull(new SolarisURI(MAINNET, BITCOIN_SCHEME + ":" + MAINNET_GOOD_ADDRESS
                + "?label=").getLabel());
    }
    ...
    public void testGood_ManyEquals() throws BitcoinURIParseException {
        assertEquals("aardvark=zebra", new SolarisURI(MAINNET, BITCOIN_SCHEME + ":"
    ...
    public void testUnknown() throws BitcoinURIParseException {
        ...
        testObject = new SolarisURI(MAINNET, BITCOIN_SCHEME + ":" + MAINNET_GOOD_ADDRESS
                + "?aardvark=true");
        assertEquals("SolarisURI['aardvark'='true','address'='"+CoinDefinition.UNITTEST_ADDRESS+"']", testObject.toString());
    ...
    public void brokenURIs() throws BitcoinURIParseException {
        ...
        SolarisURI uri = new SolarisURI(str);
    ...
    public void testBad_AmountTooPrecise() throws BitcoinURIParseException {
        new SolarisURI(MAINNET, BITCOIN_SCHEME + ":" + MAINNET_GOOD_ADDRESS
                + "?amount=0.123456789");
    }
    ...
    public void testPaymentProtocolReq() throws Exception {
        ...
        SolarisURI uri = new SolarisURI(TestNet3Params.get(), CoinDefinition.coinURIScheme + ":?r=https%3A%2F%2Fbitcoincore.org%2F%7Egavin%2Ff.php%3Fh%3Db0f02e7cea67f168e25ec9b9f9d584f9");
    ...
    public void testMultiplePaymentProtocolReq() throws Exception {
        SolarisURI uri = new SolarisURI(MAINNET,
    ...
    public void testNoPaymentProtocolReq() throws Exception {
        SolarisURI uri = new SolarisURI(MAINNET, "bitcoin:" + MAINNET_GOOD_ADDRESS);
    ...
    public void testUnescapedPaymentProtocolReq() throws Exception {
        SolarisURI uri = new SolarisURI(TestNet3Params.get(),
