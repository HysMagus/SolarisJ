...
import org.solarisj.net.discovery.PeerDiscovery;
import org.solarisj.net.discovery.PeerDiscoveryException;
...
public class MatiTest {
    ...
    public void accountDetailsTest(){
        ...
        Wallet wallet = Wallet.fromSeed(
                networkParameters,
                seed,
                DeterministicKeyChain.KeyChainType.BIP44_Solaris_ONLY
        );
    ...
    public void watchOnlyTest(){
        ...
        Wallet watchingWallet = Wallet.fromWatchingKeyB58(networkParameters,xpub,0, DeterministicKeyChain.KeyChainType.BIP44_Solaris_ONLY);
    ...
    public void syncWatchingKey() throws IOException, BlockStoreException {
        ...
        //Wallet watchingWallet = Wallet.fromWatchingKeyB58(params,pubKey,0, DeterministicKeyChain.KeyChainType.BIP44_Solaris_ONLY);
        //DeterministicKey xpubKey2 = watchingWallet.getWatchingKey();
