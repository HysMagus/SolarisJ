...
import org.solarisj.store.PostgresFullPrunedBlockStore;
...
public class PostgresFullPrunedBlockChainTest extends AbstractFullPrunedBlockChainTest
{
    ...
    // You can set up a fresh postgres with the command: create user solarisj superuser password 'password';
