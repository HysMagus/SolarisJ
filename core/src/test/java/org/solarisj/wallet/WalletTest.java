...
import org.solarisj.core.listeners.TransactionConfidenceEventListener;
import org.solarisj.core.AbstractBlockChain;
import org.solarisj.core.Address;
import org.solarisj.core.Block;
import org.solarisj.core.BlockChain;
import org.solarisj.core.Coin;
import org.solarisj.core.ECKey;
import org.solarisj.core.InsufficientMoneyException;
import org.solarisj.core.PeerAddress;
import org.solarisj.core.Sha256Hash;
import org.solarisj.core.StoredBlock;
...
import org.solarisj.core.TransactionOutPoint;
import org.solarisj.core.TransactionOutput;
import org.solarisj.core.Utils;
import org.solarisj.core.VerificationException;
import org.solarisj.core.TransactionConfidence.ConfidenceType;
import org.solarisj.crypto.*;
import org.solarisj.script.Script;
import org.solarisj.script.ScriptBuilder;
import org.solarisj.signers.StatelessTransactionSigner;
import org.solarisj.signers.TransactionSigner;
import org.solarisj.store.BlockStoreException;
import org.solarisj.store.MemoryBlockStore;
import org.solarisj.testing.*;
import org.solarisj.utils.ExchangeRate;
import org.solarisj.utils.Fiat;
import org.solarisj.utils.Threading;
import org.solarisj.wallet.Wallet.BalanceType;
import org.solarisj.wallet.WalletTransaction.Pool;
...
import org.solarisj.wallet.Protos.Wallet.EncryptionType;
...
import static org.solarisj.core.Utils.HEX;
import static org.solarisj.testing.FakeTxBuilder.*;
...
public class WalletTest extends TestWithWallet {
    ...
    public void doubleSpends() throws Exception {
        ...
        buf[43] = 0;  // Break the signature: solarisj won't check in SPV mode and this is easier than other mutations.
    ...
    public void autosaveImmediate() throws Exception {
        ...
        File f = File.createTempFile("solarisj-unit-test", null);
